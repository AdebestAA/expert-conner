export const Title = ({ title }: { title: string }) => {
  return (
    <h1 className="text-textPrimary font-semibold text-3xl">{title}</h1>
  )
}
...
export const Label = ({ title }: { title: string }) => {
  return (
    <h3 className="text-textGray font-normal text-md">{title}</h3>
  )
}

export const MedicationLabel = ({ title }: { title: string }) => {
  return (
    <h3 className="text-textGray font-bold text-md">{title}</h3>
  )
}
