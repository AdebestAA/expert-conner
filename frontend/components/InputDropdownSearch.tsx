...
export const InputDropdownSearch: React.FC<InputDropdownSearchProps> = ({
  ...
  return (
    <div className="relative w-full" onBlur={handleBlur} style={{ zIndex: 10 }}>
      <input
      ...
      {isDropdownVisible && filteredData.length > 0 && (
        <ul
          className="absolute left-0 bg-white border border-gray-300 rounded-lg w-full mt-1 max-h-60 overflow-y-auto shadow-lg z-20"
        >
