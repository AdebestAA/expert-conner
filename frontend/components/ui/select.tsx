...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-[48px] w-full items-center justify-between whitespace-nowrap rounded-md border border-[#C6CCEB] bg-[#F5F7FFB2] px-3 py-2 text-sm shadow-sm ring-offset-white data-[placeholder]:text-[#454A6C99] focus:outline-none focus:ring-1 focus:ring-gray-950 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-gray-800 dark:ring-offset-gray-950 dark:placeholder:text-gray-400 dark:focus:ring-gray-300',
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-sm  font-semibold text-[#454A6C99]', className)}
    {...props}
  />
))
