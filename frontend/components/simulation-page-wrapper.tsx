...
export const SimulationPageWrapper = ({ medicalCase, patientCase, medicalCaseId, bookmark, likes }: SimulationPageWrapperProps) => {
  return (
    <>
      {/* NOTE: Likes is from supabase. The number of likes comes from the medical case. */}
      <SimulationPage medicalCase={medicalCase} patientCase={patientCase} medicalCaseId={medicalCaseId} bookmark={bookmark} likes={likes}/>
    </>
  )
}
